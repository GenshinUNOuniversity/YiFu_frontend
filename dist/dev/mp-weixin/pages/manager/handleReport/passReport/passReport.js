...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const handleClick = () => {
      ...
      api_index.api.changeReportStatus(reportId.value, 1, message.value).catch((err) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-b6726967"]]);
